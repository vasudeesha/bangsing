...
<div id="page-wrapper">
  ...
  <?php if($is_front): ?>
    ...
    <div class="home-section-2">
      <?php print render($page['project_partners']); ?>
    </div>
    <div class="home-section-3">
      <?php print render($page['home_interest']); ?>
    </div>
    <div class="home-section-4">
        <div class="home-sec4-left">
          <?php print render($page['home_awards']); ?>
        </div>
        <div class="home-sec4-right">
          <?php print render($page['client_speaks']); ?>
        </div>
    </div>
  <?php else: ?>
    <!-- !Messages and Help -->
    ...
    <!-- !Footer -->
      ...
      <div class="footer-bottom">
        <div class="footer-bot-left">
          <?php print render($page['footer_bot_left']); ?>
        </div>
